...
final class InteractsWithMessengerTest extends WebTestCase
{
    ...
    #[Test]
    public function the_retry_listener_is_restored_after_a_throwing_process(): void
    {
        self::bootKernel(['environment' => 'failure_transport']);
        ...
        // with retries disabled, process() temporarily removes Symfony's retry listener; a throwing
        // process must still restore it afterwards (this is done in a finally block)
        ...
        // the retry listener is back: enabling retries now re-queues the failed message instead of dropping it
